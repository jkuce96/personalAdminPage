  ...
  return (
    <div className="w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105  duration-300">
            ...
            <div className="text-center font-medium">
             ...
             <p className="text-center text-4xl font-bold">API (počasí)</p>
            <div className="text-center font-medium">
            ...
            <form onSubmit={handleSubmit} className="flex flex-row items-center gap-4 px-4 mt-auto">
                <input 
                type="text"
                value={city}
                ...
                />
            <button type="submit" className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">Zjistit počasí
            </button>
            </form>
